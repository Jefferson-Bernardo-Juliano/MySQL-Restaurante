/* Incluindo dados em restaurantes */
...
-- Inserir registro direto (tabela funcionarios)
...
-- Inserir multiplos registros (tabela funcionarios)
...
-- Inserir registro direto (tabela clientes)
...
-- Inserir multiplos registros (tabela clientes)
...
-- Inserir multiplos registros (tabela produtos)
...
-- Inserir multiplos registros (tabela info_produtos)
...
-- Inserir multiplos registros (tabela pedidos)
...
-- Atualizar multiplos campos (tabela funcionarios)
update funcionarios
set cargo = 'Garçonete', salario = '2700.00'
where cpf = '444.555.666-77';

-- Atualizar com condições complexas (tabela pedidos)
update pedidos
